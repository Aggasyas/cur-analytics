...
1. Выложите в чат ЦУР накопительную выгрузку обращений с начала года
   (имя вида `nr-01.01.26-03.06.2026.xlsx`). Каждый раз присылайте СВЕЖИЙ
   накопительный файл — вся аналитика (вчера, неделя, месяц, квартал,
   исполнение, горячие точки) считается из него целиком.
